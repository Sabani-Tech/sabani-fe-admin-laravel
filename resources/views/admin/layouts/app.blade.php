                                        ...
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="col-3 align-self-center">
                                                <div
                                                    class="d-flex justify-content-center align-items-center thumb-md bg-light-alt rounded-circle mx-auto">
                                                    <i
                                                        class="ti ti-activity font-24 align-self-center text-muted"></i>
                                                </div>
                                            </div> <!--end col-->
                                        </div><!--end row-->
                                    </div><!--end card-body-->
                                        ...
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="col-3 align-self-center">
                                                <div
                                                    class="d-flex justify-content-center align-items-center thumb-md bg-light-alt rounded-circle mx-auto">
                                                    <i
                                                        class="ti ti-confetti font-24 align-self-center text-muted"></i>
                                                </div>
                                            </div><!--end col-->
                                        </div><!--end row-->
                                    </div><!--end card-body-->
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="progress mb-1">
                                        ...
                                        <div class="progress-bar bg-soft-secondary" role="progressbar"
                            ...
                            <div class="card-body">
                                <div class="table-responsive browser_users">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img src="{{ asset('assets/images/logos/chrome.png') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('assets/images/logos/micro-edge.png') }}"
                                                        alt="" height="16" class="me-2">Microsoft
                                                    Edge</td>
                                                <td>2545<small class="text-muted">(47%)</small></td>
                                                <td> 47.54%</td>
                                                <td>498<small class="text-muted">(81%)</small></td>
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('assets/images/logos/in-explorer.png') }}"
                                                        alt="" height="16"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('assets/images/logos/opera.png') }}"
